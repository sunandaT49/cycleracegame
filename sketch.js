...
mainCyclist  = createSprite(70,120,5,5);
mainCyclist.addAnimation("SahilRunning",mainRacerImg1);
mainCyclist.addAnimation("sahilcolided",mainRacerImg2);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    fill("red")
    textSize(20);
    text("Press Up Arrow Key To Restart The Game",250,200 );
  
    path.velocityX = 0;
    mainCyclist.velocityY = 0;
    mainCyclist.changeAnimation("sahilcolided",mainRacerImg2);
